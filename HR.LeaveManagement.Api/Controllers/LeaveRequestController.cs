using HR.LeaveManangement.Application.Features.LeaveRequest.Commands.CancelLeaveRequest;
using HR.LeaveManangement.Application.Features.LeaveRequest.Commands.ChangeLeaveRequestApproval;
using HR.LeaveManangement.Application.Features.LeaveRequest.Commands.CreateLeaveRequest;
using HR.LeaveManangement.Application.Features.LeaveRequest.Commands.DeleteLeaveRequest;
using HR.LeaveManangement.Application.Features.LeaveRequest.Commands.UpdateLeaveRequest;
using HR.LeaveManangement.Application.Features.LeaveRequest.Queries.GetAllLeaveRequest;
using HR.LeaveManangement.Application.Features.LeaveRequest.Queries.GetLeaveRequestDetails;
using MediatR;
