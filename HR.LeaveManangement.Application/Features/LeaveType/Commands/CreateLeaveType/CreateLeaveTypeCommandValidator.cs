...
namespace HR.LeaveManangement.Application.Features.LeaveType.Commands.CreateLeaveType
{
    public class CreateLeaveTypeCommandValidator : AbstractValidator<CreateLeaveTypeCommand>
    {
        ...
        public CreateLeaveTypeCommandValidator(ILeaveAllocationRepository leaveTypeRepository) 
        {
        ...
        private Task<bool> LeaveTypeNameUnique(CreateLeaveTypeCommand command, CancellationToken tolen)
        {
